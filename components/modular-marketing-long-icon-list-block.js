...
export default function ModularMarketingLongIconListBlock({ title, listItems, character }) {
  return (
    <div className="bg-gradient-to-b from-pink/20 to-pink relative overflow-hidden border-t border-black">
      {character && (
