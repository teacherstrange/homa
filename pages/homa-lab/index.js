          ...
          <m.div variants={fade}>
            <div className="w-full h-full min-h-screen lg:min-h-[110vh] bg-pink/30 pt-24 lg:pt-40 xl:pt-52 border-b border-black/50 px-6 xl:px-10 mx-auto relative overflow-hidden">
              ...
              <div className="max-w-screen-3xl mx-auto relative z-10">
                <h1 className="font-black text-[clamp(54px,_8.5vw,170px)] leading-[0.95] tracking-tight mb-16 lg:mb-32 uppercase relative z-10 w-full lg:w-full"><TextScrambler text="If you’re not using this, you’re just playing around" seed={50} step={3} /></h1>

                <a href="https://lab-v2.homagames.com/login" target="_blank" rel="noopener noreferrer" className="roll-btn block lg:inline-block">
            ...
            <div className="border-b border-black/50 relative overflow-hidden">
              <Container>
                <div className="flex flex-wrap py-20 pb-96 lg:py-[12vw]">
                  <div className="w-full lg:w-[45%] max-w-[750px]">
                    <h2 className="font-bold text-xl lg:text-2xl xl:text-3xl mb-8 lg:mb-[5vw] uppercase w-full lg:w-10/12 tracking-normal leading-[1.2]">Welcome to our data-powered centrifuge of ideas, insights and tools to game the system and score HITS. Lab coat optional.</h2>

                    <div className="w-full lg:w-10/12 content mb-8 lg:mb-12 leading-[1.23]">
                  ...
                  <MouseParallax enableOnTouchDevice={false} isAbsolutelyPositioned lerpEase={0.15} strength={0.025}>
                    <ScrollParallax enableOnTouchDevice={false} isAbsolutelyPositioned lerpEase={0.15}>
                      <div className="absolute bottom-[-30px] right-[25vw] lg:right-[10vw] w-[55vw] lg:w-[32vw] xl:w-[32vw] 2xl:w-[30vw] max-w-[230px] lg:max-w-[400px] 2xl:max-w-[450px] z-0">
                        {/* <Image
                    ...
                    <div className="grid grid-cols-12 ">
                      <div className="col-span-12 col-start-0 lg:col-span-10 lg:col-start-2 lg:border-l lg:border-r border-black/50">
                        <div className="grid grid-cols-10">
                          <div className="col-span-9 lg:col-span-5 mb-12 lg:mb-0 py-10 lg:py-12 px-6 lg:px-12 flex flex-wrap order-2 lg:order-1">
                            <div className="w-full mb-auto">
                              <span className="uppercase text-base tracking-widest mb-5 lg:mb-8 block font-medium">0{i + 1}</span>
                              <h2 className="font-black text-[clamp(40px,_4.45vw,_86px)] leading-[0.9] mb-12 lg:mb-32 uppercase w-11/12 max-w-[600px]">{e.title}</h2>
                            </div>
                            <div className="w-full mt-auto">
                              <div className="content mb-6 lg:mb-12 w-full lg:w-11/12 leading-[1.24]">
                                <p>{e.introText}</p>
                              </div>
            ...
            <div className="bg-lime text-black relative overflow-hidden">
              <div className="grid grid-cols-12 py-20 lg:py-[15vw] px-6 xl:px-10 max-w-screen-3xl mx-auto">
                <div className="col-span-12 lg:col-span-2 relative z-10">
                  <video loop={true} autoPlay="autoplay" playsInline={true} muted className={`w-full block lg:hidden mb-5`}>
                ...
                <div className="col-span-12 lg:col-span-8 z-10 relative">
                  ...
                  <h1 className="font-black text-[clamp(52px,_4.45vw,_86px)] leading-[0.95] mb-10 lg:mb-16 uppercase">Level up your game</h1>
                  <div className="content max-w-3xl mb-8 xl:mb-12 w-full lg:w-8/12 leading-[1.24]">
                  ...
                  <div className="w-full flex flex-wrap border border-black/50 mb-6 lg:mb-8 relative z-10 bg-lime">
                    ...
                    <div className="w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-black/50 p-5 lg:p-6 xl:p-8 2xl:p-10">
                      <h3 className="font-bold text-base tracking-tight lg:text-xl xl:text-3xl leading-[0.95] lg:leading-[0.95] xl:leading-[0.96] mb-12 lg:mb-32 uppercase">Analysis &amp; Feedback</h3>

                      <div className="content content--small leading-[1.24]">
                        <p>The weekly Homa Hangout where we dissect hit games</p>
                      </div>
                    </div>

                    <div className="w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-black/50 p-5 lg:p-6 xl:p-8 2xl:p-10">
                      <h3 className="font-bold text-base tracking-tight lg:text-xl xl:text-3xl leading-[0.95] mb-12 lg:mb-32 lg:leading-[0.95] xl:leading-[0.96] uppercase w-11/12 tracking">Best in class mentorship</h3>
                    ...
                    <div className="w-full lg:w-1/3 border-b-0 lg:border-b-0 lg:border-0 border-black/50 p-5 lg:p-6 xl:p-8 2xl:p-10">
                      <h3 className="font-bold text-base tracking-tight lg:text-xl xl:text-3xl leading-[0.95] mb-12 lg:mb-32 lg:leading-[0.95] xl:leading-[0.96] uppercase w-11/12 tracking">Access to our library</h3>
